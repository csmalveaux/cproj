...
void randGenMaze (void){
    ...
    char opening = (char) (rand() % 18);
    int entrance;

	if(opening&0x02 == 0x02){
		mmap[TOPRGHT] |= NORTH;
		mmap[TOPRGHT] |= EAST;
